  ...
  return (
    <div className="h-screen bg-gray-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl lg:w-full z-10 w-[90%] bg-gray-700 rounded-3xl mx-auto p-8">
        <h3 className="text-medium md:text-lg md:text-center font-bold tracking-wider text-gray-100">TM-UI coming soon</h3>
        <h1 className="relative z-10 sm:whitespace-nowrap text-4xl md:text-7xl  bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-blue-400  text-left md:text-center font-sans font-bold">
          Join the waitlist
        </h1>
    ...
    <div className="absolute  h-full w-full inset-0  [mask-size:40px] [mask-repeat:no-repeat] flex items-center justify-center">
      ...
      >
        ...
        <defs>
          ...
          {/* Radial Gradient for the actual placeholder lines */}
          <radialGradient
